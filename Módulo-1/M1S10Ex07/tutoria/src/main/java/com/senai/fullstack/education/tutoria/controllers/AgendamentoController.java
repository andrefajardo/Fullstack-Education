...
public class AgendamentoController {
    ...
    public ResponseEntity<List<AgendamentoEntity>> getProximosPorAlunoId(@PathVariable Long alunoId) {
        return ResponseEntity.ok(agendamentoService.buscarProximosPorAlunoId(alunoId));
    }

    @GetMapping("tutor-id/{tutorId}/proximos")
    public ResponseEntity<List<AgendamentoEntity>> getProximosPorTutorId(@PathVariable Long tutorId) {
        return ResponseEntity.ok(agendamentoService.buscarProximosPorTutorId(tutorId));
    }
    @PostMapping
