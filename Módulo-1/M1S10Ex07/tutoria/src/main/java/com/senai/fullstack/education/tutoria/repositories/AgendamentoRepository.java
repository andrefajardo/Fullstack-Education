...
public interface AgendamentoRepository extends JpaRepository<AgendamentoEntity, Long> {
    ...
    List<AgendamentoEntity> findByAlunoIdAndDataGreaterThanOrderByData(Long alunoId, LocalDateTime data);
    List<AgendamentoEntity> findByTutorIdAndDataGreaterThanOrderByData(Long tutorId, LocalDateTime data);
