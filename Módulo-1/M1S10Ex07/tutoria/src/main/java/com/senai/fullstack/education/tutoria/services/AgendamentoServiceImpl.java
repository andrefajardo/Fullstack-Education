...
public class AgendamentoServiceImpl implements AgendamentoService {
    ...
    @Override
    public List<AgendamentoEntity> buscarProximosPorAlunoId(Long alunoId) {
        alunoService.buscarPorId(alunoId);
        return agendamentoRepository.findByAlunoIdAndDataGreaterThanOrderByData(alunoId, LocalDateTime.now());
    }
    ...
    @Override
    public List<AgendamentoEntity> buscarProximosPorTutorId(Long tutorId) {
        tutorService.buscarPorId(tutorId);
        return agendamentoRepository.findByTutorIdAndDataGreaterThanOrderByData(tutorId, LocalDateTime.now());
    }
}
